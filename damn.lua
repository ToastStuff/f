...
-- Add this part to create the ScrollingFrame
local ScrollingFrame = Instance.new("ScrollingFrame")
ScrollingFrame.Parent = Frame
ScrollingFrame.Size = UDim2.new(1, -20, 1, -50) -- Set size (leave space for title/close)
ScrollingFrame.Position = UDim2.new(0, 10, 0, 50)
ScrollingFrame.BackgroundTransparency = 1
ScrollingFrame.ScrollBarThickness = 6
ScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(169, 169, 169)
...
-- Add UIListLayout for automatic layout
local UIListLayout = Instance.new("UIListLayout")
UIListLayout.Parent = ScrollingFrame
UIListLayout.Padding = UDim.new(0, buttonSpacing)  -- Space between elements
UIListLayout.HorizontalAlignment = Enum.HorizontalAlignment.Center

-- Update canvas size as new elements are added
