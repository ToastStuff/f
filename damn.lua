...
local themes = {
    Default = {
        ...
        DividerColor = Color3.fromRGB(55, 53, 55),
    },
    DarkTheme = {
    ...
    LightTheme = {
        ...
        DividerColor = Color3.fromRGB(180, 180, 180),
    }
}
...
function Library.WindowTheme(themeName)
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    ...
    function Library.NewToggle(text, callback)
        ...
        ToggleButton.BackgroundColor3 = currentTheme.BackgroundColor
    ...
    function Library.NewDivider()
        ...
        Divider.BackgroundColor3 = currentTheme.BackgroundColor  -- Dark gray color for the divider
    ...
    Divider.BackgroundColor3 = currentTheme.BackgroundColor
    ...
    function Library.NewButton(text, callback)
        ...
        NewButton.TextColor3 = currentTheme.TextColor
        NewButton.BackgroundColor3 = currentTheme.BackgroundColor
