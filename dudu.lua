...
-- Add a ScrollingFrame
local ScrollingFrame = Instance.new("ScrollingFrame")
ScrollingFrame.Parent = Frame
ScrollingFrame.Size = UDim2.new(1, -20, 1, -50) -- Leave space for the title and buttons
ScrollingFrame.Position = UDim2.new(0, 10, 0, 50)
ScrollingFrame.BackgroundTransparency = 1
ScrollingFrame.ScrollBarThickness = 6
ScrollingFrame.CanvasSize = UDim2.new(0, 0, 0, 0) -- Dynamically updated with content size
ScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(169, 169, 169) -- Dark gray color for the scrollbar

-- UIListLayout for automatic layout within the ScrollingFrame
local UIListLayout = Instance.new("UIListLayout")
UIListLayout.Parent = ScrollingFrame
UIListLayout.Padding = UDim.new(0, buttonSpacing) -- Spacing between elements
